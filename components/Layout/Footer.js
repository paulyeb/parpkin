...
const Footer = () => {
    return(
        <div className="text-white bg-gray-800 lg:px-20 2xl:pt-10 pt-2 2xl:pb-10 mt-0">
            <div className="container lg:flex lg:flex-row lg:justify-start lg:flex-wrap lg:items-start grid grid-cols-2 gap-4">
                    ...
                    <ul>
                        <li>
                            <Link href="https://goo.gl/maps/NaR5o5T11uvWLTmu8" target="_blank">
                                <a><FontAwesomeIcon icon={faLocationDot} className="m-2 p-2" style={{ color: 'yellow', width: '45px', height: '45px'}} /></a>
                            </Link>
                        </li>
                    </ul>
                </div>
                <div className="lg:ml-20 flex flex-col">
                    ...
                    <div className="flex">
                        <Link href={"https://instagram.com/parpkin?igshid=YmMyMTA2M2Y="} target="_blank">
                            <a><FontAwesomeIcon icon={faInstagram} className="m-2 p-2 border border-gray-500 rounded-full" style={{ color: 'purple', width: '45px', height: '45px'}} /></a>
                        </Link>
                        <Link href={"https://twitter.com/parpkinshawarma?s=20&t=M_5b30S8mSGpa3yO7RbAyA"} target="_blank">
                            <a><FontAwesomeIcon icon={faTwitter} className="m-2 p-2 border border-gray-500 rounded-full" style={{ color: 'skyblue', width: '45px', height: '45px'}} /></a>
                        </Link>
                    </div>
                </div>
            </div>

            <div className="2xl:mt-20 mt-7 pb-2 flex flex-col justify-center items-center">
